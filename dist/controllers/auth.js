...
function googleAuth(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const accessToken = jsonwebtoken_1.default.sign(payload, process.env.ACCESS_TOKEN_SECRET || "secret", { expiresIn: "7d" });
            const refreshToken = jsonwebtoken_1.default.sign(payload, process.env.REFRESH_TOKEN_SECRET || "refresh-secret", { expiresIn: "30d" });
            ...
            console.error("Google auth error:", ((_a = error === null || error === void 0 ? void 0 : error.response) === null || _a === void 0 ? void 0 : _a.data) || error);
...
function generateAuthToken(user) {
    ...
    return jsonwebtoken_1.default.sign(payload, process.env.JWT_SECRET || "your_jwt_secret_here", {
        expiresIn: "7d",
    });
}
function googleAuthCallback(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const { email, name, picture } = userInfoResponse.data;
            const user = yield findOrCreateGoogleUser({ email, name, picture });
            const token = generateAuthToken(user);
            return res.redirect(`${frontendUrl}/auth/success?token=${token}`);
        }
        catch (err) {
            console.error("Google Auth Callback Error:", ((_a = err === null || err === void 0 ? void 0 : err.response) === null || _a === void 0 ? void 0 : _a.data) || err.message);
            return res.status(500).json({ error: "Failed to authenticate with Google" });
        }
    });
}
